...
public interface MobItems {
	...
	ItemStack LOBBY = Item.createItem("§c§lBACK TO LOBBY", "", Material.BED, 1, 0);
	ItemStack AUTO_RESPAWN_ON = Item.createItem("§a§lAUTO_RESPAWN", "", Material.EYE_OF_ENDER, 1, 0);
	ItemStack AUTO_RESPAWN_OFF = Item.createItem("§c§lAUTO_RESPAWN", "", Material.ENDER_PEARL, 1, 0);
