...
public class PigItems implements MobItems {
	...
	static final String ABILITY_1_TIER_1_NAME = "Not enough?";
	static final String ABILITY_1_TIER_1_DESC = "Increases lifesteal-effect by 20%.#Total: 40%";
	static final String ABILITY_2_TIER_1_NAME = "Pain? Why not.";
	static final String ABILITY_2_TIER_1_DESC = "Every hooked enemy gets 2 hearts damage.";
	static final String ABILITY_3_TIER_1_NAME = "Blind Rush";
	static final String ABILITY_3_TIER_1_DESC = "Saddled enemies get a blinding effect.";
	static final String ABILITY_1_TIER_2_NAME = "Fire makes things better!";
	static final String ABILITY_1_TIER_2_DESC = "Adds a 3s burn effect to your enemies.";
	static final String ABILITY_2_TIER_2_NAME = "Power Hook";
	static final String ABILITY_2_TIER_2_DESC = "Half the cooldown, double the power.";
	static final String ABILITY_3_TIER_2_NAME = "Burn in hell!";
	static final String ABILITY_3_TIER_2_DESC = "2 hearts more damage over time#and the target gets a 5s burn effect#when he/she saddles down.";
