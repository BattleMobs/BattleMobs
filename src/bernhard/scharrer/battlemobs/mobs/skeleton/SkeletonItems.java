...
public class SkeletonItems implements MobItems {
    ...
    static final String ABILITY_1_TIER_1_NAME = "Bow++";
    static final String ABILITY_1_TIER_1_DESC = "Adds a FLASH-Effect and deals#1 heart more damage.";
    static final String ABILITY_2_TIER_1_NAME = "Twice Spins, Twice Fun";
    static final String ABILITY_2_TIER_1_DESC = "Makes a second spin after 1 second.";
    static final String ABILITY_3_TIER_1_NAME = "Better Conditions";
    static final String ABILITY_3_TIER_1_DESC = "While riding you deal twice as much damage.";
    static final String ABILITY_1_TIER_2_NAME = "Little Confusion?";
    static final String ABILITY_1_TIER_2_DESC = "Rotate enemies head randomly#on succesfull hit.";
    static final String ABILITY_2_TIER_2_NAME = "More Spins!";
    static final String ABILITY_2_TIER_2_DESC = "+2 extra spins in a 1s rythmus##+adds a little flash everyetime#enemy is rotating.";
    static final String ABILITY_3_TIER_2_NAME = "U can't see me.";
    static final String ABILITY_3_TIER_2_DESC = "Succesfully hits while riding#blinds your enemies for 3s.";
